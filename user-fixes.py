...
fixes['inva-wp-es'] = {
    ...
    'replacements': [
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Aa]utorenllaç(\s*=.*?})', ur'\1enlaceautor\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Cc]ognom(\s*=.*?})', ur'\1apellido\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Ee]nllaçautor(\s*=.*?})', ur'\1enlaceautor\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Nn]om(\s*=.*?})', ur'\1nombre\2'), #ca
