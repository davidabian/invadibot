...
fixes['inva-wp-es'] = {
    ...
    'replacements': [
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Aa]uthor(\d*\s*=.*?})', ur'\1autor\2'),
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Aa]uthorlink(\d*\s*=.*?})', ur'\1enlaceautor\2'),
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Aa]utorenllaç(\d*\s*=.*?})', ur'\1enlaceautor\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Cc]ognom(\d*\s*=.*?})', ur'\1apellido\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Ee]nllaçautor(\d*\s*=.*?})', ur'\1enlaceautor\2'), #ca
        ...
        (ur'({{[\s_]*(?:[Pp]lantilla[\s_]*:|[Tt]emplate[\s_]*:)?[\s_]*[Cc]ita[ _](?:libro|noticia|publicación|web)[^}]*?\|\s*)[Nn]om(\d*\s*=.*?})', ur'\1nombre\2'), #ca
